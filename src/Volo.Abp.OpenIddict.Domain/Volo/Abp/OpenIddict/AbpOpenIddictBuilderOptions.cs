...
public class AbpOpenIddictBuilderOptions
{
    ...
    /// Set false to suppress AddDevelopmentEncryptionCertificate() and AddDevelopmentSigningCertificate() call on the OpenIddictServerBuilder.
    /// Default: false.
    /// </summary>
    public bool AddDevelopmentCredentials { get; set; } = false;
    ...
    /// Default: true.
    /// </summary>
    public bool AddEphemeralCredentials { get; set; } = true;
